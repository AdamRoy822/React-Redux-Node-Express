...
import { Dimer,Confirm } from 'semantic-ui-react';
...
class InfoUsers extends Component {
  ...
  componentWillMount() {
    this.props.userList("users/info_registered");
  }
      ...
      <div className="animated fadeIn">
        <Row>
          <Col>
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify" /> Info Users
              </CardHeader>
              <CardBody>
...
export default compose(withConnect)(InfoUsers);
