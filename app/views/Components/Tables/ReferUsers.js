...
class ReferUsers extends Component {
  constructor(...args) {
    super(...args);
    this.state = {
      deleteId: null,
  ...
  componentWillMount() {
    this.props.userList("users/user_refer");
  }
      ...
      <div className="animated fadeIn">
        <Row>
          <Col>
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify" /> Referral Users
              </CardHeader>
              <CardBody>
...
export default compose(withConnect)(ReferUsers);
